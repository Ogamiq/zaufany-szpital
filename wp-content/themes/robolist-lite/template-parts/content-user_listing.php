...
if(!empty($fav)) {
    ...
    echo '<div class="section"><div class="container"><div class="row"><div class="col-md-12">';
    echo '<p>'.esc_html__('No Any Favorite Listing Found.','robolist-lite').'</p>';
